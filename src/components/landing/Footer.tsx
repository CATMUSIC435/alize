...
export function Footer() {
  ...
  return (
    <footer className="relative z-10 flex min-h-[80vh] w-full flex-col items-center justify-between overflow-hidden bg-[#2A141D] px-6 py-12 text-[#F4F3ED] md:px-12 md:py-20">
      <motion.div
