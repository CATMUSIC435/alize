...
/**
 * Hero section for the Legal page featuring undulating sand ripples and wave dividers.
 * @param props Hero component parameters including document count.
 * @returns The LegalHero component.
 */
export function LegalHero(props: LegalHeroProps) {
  const t = useTranslations('LegalPage');
  const count = props.documentCount ?? 8;
  ...
  return (
    <section className="relative w-full overflow-hidden bg-transparent pt-[16vh] pb-[4vh] md:pt-[20vh] md:pb-[6vh]">
      {/* Floating Wavy Line Ribbons in the Background */}
      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-6 flex items-center gap-2 text-[9px] font-bold tracking-[0.2em] text-[#151926]/60 uppercase sm:text-[10px]">
          ...
          <span className="text-[#8B7043]">{t('breadcrumb_legal')}</span>
        </motion.div>

        {/* Main Typographic Headline & Count */}
        ...
        {/* Hairline Divider & Editorial Narrative */}
        <motion.div
