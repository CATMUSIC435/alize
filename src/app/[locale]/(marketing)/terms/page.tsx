...
/**
 * Generates SEO metadata for the Terms of Use page.
...
export async function generateMetadata(props: TermsPageProps): Promise<Metadata> {
  ...
  const alternates = getI18nAlternates('/terms', locale);
  ...
  return {
    title,
    description,
    keywords: getLocalizedKeywords('terms', locale),
    alternates,
    openGraph: {
      title,
      description,
...
/**
 * Dedicated Terms of Use legal content page.
 * @param props Page parameters promise.
 * @returns The TermsPage component.
 */
      ...
      <main className="bg-textured-sand relative min-h-screen w-full pt-[16vh] pb-24 md:pt-[20vh] md:pb-36">
        ...
        <article className="relative z-10 mx-auto w-full max-w-[1000px] px-6 md:px-12">
          ...
          <div className="mb-6 flex items-center gap-2 text-[9px] font-bold tracking-[0.2em] text-[#151926]/60 uppercase sm:text-[10px]">
            ...
            <span className="text-[#8B7043]">{t('breadcrumb_terms')}</span>
          </div>
